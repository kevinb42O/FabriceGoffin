        ...
        */}
        <div className="grid grid-cols-1 md:grid-cols-12 md:grid-rows-[auto_1fr] gap-x-12 lg:gap-x-16 gap-y-10 md:gap-y-12">
          ...
          <div className="md:col-span-5 flex items-center gap-4">
            ...
            <span className="text-red-600 font-bold uppercase tracking-[0.2em] text-[11px]">
              Oostende — 8400
            </span>
          </div>
          ...
          <div className="md:col-span-5">
            ...
            <Link to="/" className="inline-flex items-center gap-4 group" aria-label="Fabrice Goffin — home">
              ...
              <div className="flex flex-col justify-center">
                <span className="text-[13px] font-black tracking-[0.2em] uppercase leading-none text-zinc-900">
                  Fabrice Goffin
                </span>
                <span className="text-[9px] font-bold tracking-[0.2em] uppercase leading-none mt-1.5 text-red-600">

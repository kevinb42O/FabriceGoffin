        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center relative z-10">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center px-6 md:px-0">
            ...
            <div className="flex flex-col mb-8 z-10 relative">
               <h1 className="text-[70px] md:text-[100px] lg:text-[130px] xl:text-[150px] font-black tracking-tighter leading-none uppercase text-zinc-900 font-heading">
                 <StaggerText text="IK BEN" />
               </h1>
               <span className="text-[70px] md:text-[100px] lg:text-[130px] xl:text-[150px] font-black tracking-tighter leading-none uppercase text-red-600 drop-shadow-sm -mt-2 lg:-mt-6 block font-heading" aria-hidden="true">

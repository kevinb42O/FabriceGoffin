      ...
      <div className="flex flex-col gap-5">
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 p-6">
            ...
            <span className="text-red-400 font-medium uppercase tracking-[0.22em] text-[10px] mb-3 block font-heading">
              Toekomst
            </span>
            <h3 className="text-white text-2xl font-medium uppercase tracking-tight leading-[0.95] font-heading">

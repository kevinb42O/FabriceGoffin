    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-red-400 font-black uppercase tracking-[0.22em] text-[10px] drop-shadow-md">
      ...
      >
        ...
        <h1 className="font-black tracking-tighter leading-[0.85] uppercase mb-5">
